...
| `core.durable_codec.DurableCodec`, `DurableLoadResult` | `OR-07-DURABLE-METADATA` | Parse artifact families/versions, distinguish checked load outcomes, and apply pure ordered migrations before checkpoint or run-metadata recovery. |
