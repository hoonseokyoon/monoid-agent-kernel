...
- **I'm running a backend/gateway** → [BACKEND.md](BACKEND.md) for the reference
  ...
  durable run-lifecycle profile and its adoption gates.
...
| [DBOS_REFERENCE.md](DBOS_REFERENCE.md) | Experimental DBOS run-lifecycle profile, stable-slot recovery model, verified crash invariant, and adoption gates. |
