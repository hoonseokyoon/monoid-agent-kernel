...
from native_agent_runner.reference.mcp_gateway.service import FakeMcpError, FakeMcpServer

_LOGGER = logging.getLogger("native_agent_runner.mcp_gateway.http")
