...
def exact_runtime_string(value: Any, *, field_name: str) -> str:
    """Validate a runtime/control string without coercing another scalar type."""
...
def exact_runtime_bool(value: Any, *, field_name: str) -> bool:
    """Validate a runtime/control boolean without truthiness coercion."""
