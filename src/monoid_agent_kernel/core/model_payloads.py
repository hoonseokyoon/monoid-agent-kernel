...
def iter_chunk_references(value: Any) -> Iterator[str]:
    ...
    Markers are recognized by the same predicate extraction uses, never re-derived, so a
    marker-shaped object carrying a malformed sha yields nothing -- and it also names nothing a
